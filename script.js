// Project data
const projects = [
    { id: 1, category: 'ai', featured: true, badge: { en: 'Graduation Project', tr: 'Bitirme Projesi' }, badgeClass: 'featured-badge', date: '2025 - 2026', title: { en: 'SummarAIze - Meeting Assistant', tr: 'SummarAIze - Toplantı Asistanı' }, tech: ['React', 'Python', 'Supabase', 'LLM'], description: { en: 'Led a team of 5 engineers to develop a system for Zoom calls with real-time transcription and AI-powered summarization.', tr: '5 mühendisten oluşan bir ekibe liderlik ederek Zoom aramaları için gerçek zamanlı transkripsiyon ve yapay zeka destekli özetleme sistemi geliştirdim.' }, github: 'https://github.com/Coders-Endgame/ata-meeting-assistant' },
    ...
    { id: 12, category: 'hardware', badge: { en: 'TUBITAK', tr: 'TÜBİTAK' }, date: '2019', title: { en: 'TUBITAK 4006 - Smart House', tr: 'TÜBİTAK 4006 - Akıllı Ev' }, categoryLabel: { en: 'Technology', tr: 'Teknoloji' }, description: { en: 'Smart phone controlled home automation concept.', tr: 'Akıllı telefon kontrollü ev otomasyon konsepti.' } }
];
